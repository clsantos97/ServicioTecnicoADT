...
public class ClienteMainController implements Initializable {
    ...
    private ClienteManager clienteManager = new ClienteDAO();
    ...
    @FXML
    private TableColumn<ClienteBean, String> tcRegDate;
    @FXML
    ...
    public void initTable() {
        ...
        tcRegDate.setCellValueFactory(new PropertyValueFactory<>("redate"));
